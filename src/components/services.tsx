const Services = () => {
  return (
    <section>
      ...
      <ul>
        <li>
          <strong>Podcast production:</strong> We can help you create, produce,
          and launch your podcast. We'll work with you to develop your concept,
          find guests, record and edit your episodes, and promote your podcast.
        </li>
        <li>
          ...
          platforms like Instagram, Facebook, and TikTok. We'll work with you to
          develop your concept, shoot your video, and edit it to perfection.
        </li>
        <li>
          <strong>Sound design:</strong> We can help you create soundscapes and
          sound effects for your audio content. We'll work with you to create
          the perfect atmosphere for your story or project.
        </li>
        <li>
        ...
        <li>
          ...
          with your vertical videos. We'll work with you to identify your target
          audience, create engaging content, and measure your results.{" "}
        </li>
        <li>
