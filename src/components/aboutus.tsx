const AboutUs = () => {
  return (
    <>
      ...
      <p>
        We believe that emotion is the most powerful way to connect with people.
        That's why <strong>we always start with a feeling</strong> when we
        create our content. We want our listeners to feel something when they
        listen to our work - whether it's laughter, sadness, excitement, or
        anything in between.
      </p>
      <p>
